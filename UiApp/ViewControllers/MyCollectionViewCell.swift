...
class MyCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        updateButton = UIButton(frame: CGRect(x: 0, y: contentView.frame.height - 40, width: contentView.frame.width, height: 40))
        ...
        tableView.frame = CGRect(x: 0, y: 0, width: contentView.frame.width, height: contentView.frame.height - 55)
        [tableView,updateButton].forEach {contentView.addSubview($0)}
